...
func (obj *QosForwardingClass) GetPerms2() PermType2 {
        return obj.perms2
}

func (obj *QosForwardingClass) SetPerms2(value *PermType2) {
        obj.perms2 = *value
        obj.modified |= qos_forwarding_class_perms2
}
...
func (obj *QosForwardingClass) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & qos_forwarding_class_perms2 != 0 {
                var value json.RawMessage
...
func (obj *QosForwardingClass) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "perms2":
                        ...
                        if err == nil {
                                obj.valid |= qos_forwarding_class_perms2
                        }
                        break
                case "display_name":
